...
<main class="grid g-x">
    <!-- Name uwu -->
    <div>
        <h1 class="bigtitle"><b class="invert-text">キム&lt;</b>🌱<b class="invert-text">&gt;</b></h1>
...
<style>
    ...
    .socials { background-color: var(--color-bg-socials); }
    .social-icon { height: 2rem; width:  2rem; fill: var(--color-border) }

    .twitter:hover * { fill: #8fe2ef; }
    .github:hover * { fill: #b2ef8f }
    .discord:hover * { fill: #8fb7ef; }
